...
<ul class="menu_list">
    ...
    <!-- <li><a href="index.php?action=quanlydanhmucbaiviet&query=them">Quản lý danh mục nghệ sĩ</a></li> -->
    <!-- <li><a href="index.php?action=quanlybaiviet&query=them">Quản lý nghệ sĩ</a></li> -->
